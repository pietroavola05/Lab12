...
class View:
    ...
    def load_interface(self):
        ...
        self.pulsante_percorso_minimo = ft.ElevatedButton("Percorso Minimo", width=200,
                                                      on_click=self.controller.handle_percorso_minimo if self.controller else None)
        row3 = ft.Row([self.pulsante_percorso_minimo], alignment=ft.MainAxisAlignment.CENTER)
